...
//            }
        ...
        connect: {
            ...
            rules: [
                {from: '/api', to: '/bower_components/geo-model/src/region', redirect: 'permanent'}
            ],
            livereload: {
                options: {
            ...
            compile: {
                options: {
                    ...
                    processName: function (filename) {
                      return filename.replace(/(app\/scripts\/templates\/)([A-Za-z-_]+)(\.ejs)/, '$2');
                    },
    ...
    grunt.registerTask('createDefaultTemplate', function () {
        grunt.file.write('app/scripts/tmp/templates.js', 'window.Web = window.Web || {}; window.Web.Templates = window.Web.Templates || {};');
    });
